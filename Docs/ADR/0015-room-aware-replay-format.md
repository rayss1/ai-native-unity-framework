...
- Production remains one room per process until an exact-`main` replay-enabled capacity run passes and the independent environment canary/rollback gate is approved.
