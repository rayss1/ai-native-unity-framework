...
| [0005](0005-authoritative-simulation-and-reconciliation.md) | Accepted | 60 Hz authority model | Server authority, fixed Tick, prediction/reconciliation, no lockstep | WS-26 exact-main transport/Player passed; WS-27 Regional real-client evidence and mobile IL2CPP remain |
