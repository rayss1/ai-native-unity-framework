...
| [0005](0005-authoritative-simulation-and-reconciliation.md) | Accepted | 60 Hz authority model | Server authority, fixed Tick, prediction/reconciliation, no lockstep | Shared baseline passed prior Unity/Linux gates; WS-25 client adapter exact-commit Unity, concrete transport, Regional correction, and mobile/IL2CPP gates remain |
