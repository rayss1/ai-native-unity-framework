...
| [0005](0005-authoritative-simulation-and-reconciliation.md) | Accepted | 60 Hz authority model | Server authority, fixed Tick, prediction/reconciliation, no lockstep | Bounded Shared baseline implemented; exact-commit Unity and Regional correction thresholds remain |
