...
| [0005](0005-authoritative-simulation-and-reconciliation.md) | Accepted | 60 Hz authority model | Server authority, fixed Tick, prediction/reconciliation, no lockstep | WS-26 exact-main macOS transport/Player and Linux gates passed; Regional real-client correction and mobile IL2CPP remain |
