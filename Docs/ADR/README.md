...
| [0005](0005-authoritative-simulation-and-reconciliation.md) | Accepted | 60 Hz authority model | Server authority, fixed Tick, prediction/reconciliation, no lockstep | WS-27 Regional gate passed; WS-28 presentation smoother awaits exact-commit evidence; prediction physics and mobile IL2CPP remain |
...
| [0014](0014-temporary-manual-unity-validation.md) | Accepted | Temporary manual Unity validation | Exact-commit Unity 6000.3.9f1 evidence is mandatory while credentialed CI is unavailable | Current WS-28 macOS contract is 44 EditMode + 2 PlayMode + ARM64/Regional Player; exact evidence pending; Windows/mobile remain separate |
