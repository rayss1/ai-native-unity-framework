...
| [0005](0005-authoritative-simulation-and-reconciliation.md) | Accepted | 60 Hz authority model | Server authority, fixed Tick, prediction/reconciliation, no lockstep | WS-25 exact-main Unity/Linux gates passed; concrete Unity transport, Regional real-client correction, and PlayMode/mobile IL2CPP remain |
