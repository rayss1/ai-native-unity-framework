...
| [0014](0014-temporary-manual-unity-validation.md) | Accepted | Temporary manual Unity validation | Exact-commit Unity 6000.3.9f1 evidence is mandatory while credentialed CI is unavailable | WS-28 exact-main 44 EditMode + 2 PlayMode + ARM64/Regional Player passed; Windows/mobile remain separate |
